...
class EquipeDetails extends StatefulWidget {
  ...
  final int def;
    final String url;
    EquipeDetails(this.club,this.nom,this.def,this.vic,this.url);
...
delUsers().then((value) => 
 Navigator.pop(context),
  ...
  AlertDialog alert2 = AlertDialog(
    title: Text("Favoris"),
    content: Text("Voulez-vous enlever ${widget.club} en tant qu'équipe favorite?"),
    actions: [
      cancelButton,
      continueButton2,
    ],
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: PreferredSize(
          preferredSize: Size.fromHeight(height/2.9),
          child: AppBar(
                     ...
                     child:  Container(
                       ...
                       child: Padding(
                         ...
                         child: IconButton(
                           ...
                           color:  tr ? Colors.red : favcol ,
                           onPressed: (){
                             if (_joueur[0]['Favoris']==widget.club) {
                                                           showDialog(
    context: context,
